...
```shell
pkg update -y && pkg upgrade -y && pkg install python git && git clone https://github.com/LunarDevelopment1/LunarDev-Nuker && cd LunarDev-Nuker1 && pip install -r requirements.txt && python Lunar.py
```
